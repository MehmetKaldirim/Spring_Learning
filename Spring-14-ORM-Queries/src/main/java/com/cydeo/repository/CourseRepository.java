...
public interface CourseRepository extends JpaRepository<Course,Long> {
    ...
    //find all by category and  order the entities by name
    List<Course> findByCategoryOrderByName(String category);

    //check if a course with the previded name exists , return true or false
    boolean existsByName(String name);

    //return current count of courses for the provided category
